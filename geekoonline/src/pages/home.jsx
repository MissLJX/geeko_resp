      ...
      <RES1 width1={624} width2={513}>
        <BLOCKER >
          ...
          <CONTENT1S style={{marginTop: 14}}>
            <CONTENT1>
              上海极高是一家成立于2015年的跨境B2C互联网企业，专注于经营女性快时尚领域，为全球消费者提供高性价比的时尚产品。公司总部设在上海，并在广州、南京、香港、合肥、美国等多个地方开设分支机构，目前已经进入了北美、南美、欧洲等市场。
            </CONTENT1>
            <CONTENT1>
              2015年起，公司自有品牌CHICME上线，依托国内外的产品和供应链优势，不断整合行业资源，建立从设计开发到纸样打版，从面料采购到成衣制造，从电商运营到售后服务的完备的运营体系。
            </CONTENT1>
            <CONTENT1>
              依靠良好的质量与口碑、快速更新的款式、强大的供应链体系、十多年的跨境电商行业运营经验，CHICEME会员数量不断增长，到目前为止海外会员数已超过600万。
            </CONTENT1>
            <CONTENT1>
              我们秉承客户至上的工作理念，不断优化公司运营机制，不断提升品牌经营水平。如果你热爱时尚行业；如果你有志于投身互联网品牌出海浪潮；欢迎你加入我们，亲手创造全球时尚电商行业下一个奇迹！
            </CONTENT1>
          </CONTENT1S>
        </BLOCKER>
        <BLOCKER>
        ...
        <BLOCKER style={{direction: 'ltr'}}>
          ...
          <HISTORIES style={{marginTop: 23}}>
            ...
            <li>
              ...
              <div><p className="__dsc">旗下首个女装品牌网站 chicme.com上线运营</p></div>
            </li>
            <li>
            ...
            <li>
              ...
              <div><p className="__dsc">美国公司成立，销售额突破1亿美金</p></div>
            </li>
            <li>
              <div><span className="__title">2018年</span></div>
              <div><p className="__dsc">旗下品牌超过10个，Facebook粉丝累积超过800万，Instagram粉丝超过100万</p></div>
            </li>
            <li>
              <div><span className="__title">2019年</span></div>
              <div><p className="__dsc">业务覆盖全球224个国家和地区，业务额增长率稳定保持在100%以上</p></div>
            </li>
          </HISTORIES>
        </BLOCKER>
