...
export default () => <div>
  ...
  <section style={{marginTop: 50}}>
    <video style={{width: '100%'}} src="/images/chic.mp4" autoPlay/>
  </section>
  </CONTAINER>
  <CONTAINER>
      ...
      <RES1 width1={624} width2={513}>
        <BLOCKER >
          ...
          <CONTENT1S style={{marginTop: 14}}>
            ...
            <CONTENT1>
            依靠良好的质量与口碑、快速更新的款式、强大的供应链体系、十多年的跨境电商行业运营经验，CHICEME会员数量不断增长，到目前为止海外会员数已超过1000万，Instagram粉丝数200万。
            </CONTENT1>

            <CONTENT1>
            目前，我们已打造出以CHICME为首的品牌矩阵，同步开发了PC端、IOS移动端、Andriod移动端购物商城。4年来公司业务在快速的扩张，但是我们依旧不改初心，始终把用户体验当做重心，积极倾听理解客户需求，面对市场变化快速反应；自主研发各业务后台的IT支持系统，不断优化业务流程，使得各个业务环节无缝链接。拥有自实现云平台，具备高扩展、高可用、高性能的应用服务，并引入大数据引擎分析用户行为及可自我学习的核心算法。为了能快速解决客户的各种问题，客服团队迅速扩展到80多人。我们始终致力于带给用户极致的购物体验
            </CONTENT1>

            <CONTENT1>
            我们秉承客户至上的工作理念，不断优化公司运营机制，不断提升品牌经营水平。公司销售额以每年100%的速度稳步快速提升，在18年的销售额已经达到10亿以上体量。
            </CONTENT1>
