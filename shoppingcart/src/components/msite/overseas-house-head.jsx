...
const OverseasouseHead = ({shippingMethod, selected, groupClick, intl, count, isShippingHead}) => <OverseasHead>
	<div className="x-table __vm __fixed x-fw">
...

		{
			...
			</React.Fragment>: <div className="x-cell" style={{width:'auto'}}>
