...
const BUILD_PATH = path.resolve(ROOT_PATH, 'dist_confirm_msite')
...
module.exports = {
  ...
  output: {
  	path: BUILD_PATH,
    publicPath: '/wanna/resources/js/react/msite/order_confirm/',
    // publicPath: '/wanna/resources/js/react/pc/order_confirm/',
