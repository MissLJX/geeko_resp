<template>
  <div class="selectMask" @click="cfg.close">
    <div class="st-confirm" :style="boxStyle">
      ...
      <span
        v-if="cfg.showSuccessIcon"
        class="iconfont success_icon"
        :style="iconStyle"
        >&#xe6b7;</span
      >
      ...
      <template>
        ...
        <div class="message2" v-else :style="message2Style">
          <p>{{ cfg.message2 }}</p>
        </div>
      </template>
      ...
      <div class="fd">
        <template v-if="isButtonList">
          <button
            :class="{ 'l-vue-btn': true, no: item.type == 'no' }"
