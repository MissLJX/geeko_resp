    ...
    <div class="coupons">
        ...
        <div class="coupon" v-for="item in coupons">
            ...
            <div class="x-table __vm x-fw __fixed"
                :style="{background: item.isAvailable ?
                ...
                <div class='couponMainInfo'>
                    <div class="x-cell" style="height: 100%">
                        <div style="display: flex; align-items: center; justify-content: flex-start">
                            <span class="couponAmount" :style="{'color':item.isAvailable?'#ff782a' : '#999'}">{{item.coupon.couponName2}}</span>

                        </div>
                        
                        <div v-if="item.coupon.name" :style="{ 'margin-top': 6, 'color': item.isAvailable ? '#ff782a' : '#999' }">
                            <span class='description'>{{item.coupon.name}}</span>
                        </div>
                    
                        <div v-if="item.coupon.description" :style="{ 'margin-top': 6, 'color': item.isAvailable ? '#ff782a' : '#999' }">
