export default {
    ...
    my_vip:{
        ...
        level_requirement:'Stufenanforderung',
        level_up_rule_1: '0,01 USD oder 1 Bestellung(en) (über 0,01 USD) sind erforderlich, um das V1-Level zu erreichen.',
        level_up_rule_2: '100,00 US-Dollar oder 2 Bestellungen (über 0,01 US-Dollar) sind erforderlich, um das V2-Level zu erreichen.',
        level_up_rule_3: '200,00 USD oder 3 Bestellungen (über 0,01 USD) sind erforderlich, um das V3-Level zu erreichen.',
        view_rules: 'Regeln anzeigen',
        vip_rewards:'{website} VIP BELOHNUNGEN',
        redeem_now: 'Jetzt einlösen',
        download_now: 'Jetzt herunterladen',
        check_coupons: 'Meine Gutscheine prüfen',
        get_reward: 'Belohnung erhalten',
        vip_faqs: 'Häufig gestellte Fragen',
        vip_congratulations: 'Herzlichen Glückwunsch',
