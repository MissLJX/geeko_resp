        ...
        return (<div>
            {
                ...
                <div style={{position:'relative'}}>
                    <Page label={<span style={{color:'#DDC35E'}}><span className="iconfont" style={{marginRight: '5px'}}>&#xe783;</span>{intl.formatMessage({id: 'vip_service'})}</span>} style={{backgroundColor:'#f6f6f6'}}>
