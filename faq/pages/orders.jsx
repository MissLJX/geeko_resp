  ...
  render () {
    ...
    return <div>
      ...
      <PageContanier>
          ...
          <GeekoSelect value={this.state.currentPage} onChange={(evt) => {this.setState({currentPage: evt.currentTarget.value}); this.props.history.replace(`/me/m/faq/orders/${evt.currentTarget.value}`) }} style={{width: '100%', height: '40px', marginTop: '10px'}}>
            {this.paths.map(p => (
      	...
      	<div style={{marginTop: '120px'}}>
            ...
            <Route path={`${window.ctx||''}/me/m/faq/orders/:page`} component={OrdersPath}/>
            <Route path={`${window.ctx||''}/me/m/faq/orders`} component={OrdersPath}/>
      		</Switch>
      	</div>
      </PageContanier>
    </div>
