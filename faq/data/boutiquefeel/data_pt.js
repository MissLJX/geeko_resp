...
const question14 = {
  ...
  richText: `
		<article>
			...
			<section>
				<p>
					Acompanhar o seu pacote é fácil. Você pode entrar em sua conta Boutiquefeel e encontrar todas as informações do seu pedido. Clique em "Meus Pedidos" e clique em "Visualizar Detalhes" para descobrir onde está seu pacote. Você também pode enviar um ticket ou e-mail para verificar as informações do seu pedido.
				</p>
			</section>
		</article>
	`
