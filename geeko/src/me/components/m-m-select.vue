<template>
    <div :class="selectBoxClass" @click.stop="select">
        <span>{{value}}</span>
        <img class="m-m-select-icon" alt="" src="https://s3.us-west-2.amazonaws.com/image.chic-fusion.com/chicme/2021-08-11/2021-08-11-select-down.png">
...
<script type="text/ecmascript-6">
    export default {
        ...
        computed: {
            ...
            defaultV:{
                get:function(){
                    return this.defaultValue ? this.defaultV : 
