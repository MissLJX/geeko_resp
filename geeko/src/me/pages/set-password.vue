                ...
                <div class="item1">
                    ...
                    <span :class="{'active-animation':fontActive}">
                        <i18n path="label.agree_to_policy" tag="span" for="label.terms_of_services">
                            <a :href="GLOBAL.getUrl('/policy/terms-conditions-notice')">{{$t("label.terms_of_services")}}</a>
                        </i18n>
                        <a :href="GLOBAL.getUrl('/policy/privacy-security-policy')">{{$t("index.privacy_policy")}}  </a>
                    </span>
                </div>
