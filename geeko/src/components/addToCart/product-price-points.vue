...
<template>
    <div class="product-price">
        ...
        <div class="_prices">
            <span class="x-product-price" v-html="price">
            </span>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            price(){
                // 当有积分价格，且显示积分时
                if(this.variantProduct && this.variantProduct.pointsMallVariantSales && JSON.stringify(this.variantProduct.pointsMallVariantSales) != '{}'){
                    return getPointsMoney(this.variantProduct.pointsMallVariantSales)
                }
