...
export default {
    ...
    label: {
        ...
        email_not_be_empty:"L'adresse e-mail ne peut pas être vide, veuillez saisir une adresse e-mail valide",
        email_address_not_available:"L'adresse e-mail n'est pas disponible, veuillez saisir une adresse e-mail valide.",
        password_not_be_empty:"Le mot de passe ne peut pas être vide, veuillez saisir le mot de passe de ce compte.",
        temporarily_not_support:"Ne prend temporairement pas en charge d'autres comptes (Google, Facebook, Apple, etc.) pour changer d'e-mail.",
        success_will_send_lastest:"Succès! Nous enverrons notre dernière newsletter à votre nouvelle adresse e-mail.",
        the_email_already_register:"Cette adresse e-mail est déjà enregistrée, veuillez changer pour une autre adresse e-mail valide.",
        password_is_incorrect_error:"Le mot de passe est incorrect, veuillez saisir un mot de passe valide pour ce compte.",
        relation_products:"Produits relationnels",
        delete_all_expried_products:"Êtes-vous sûr de vouloir supprimer tous les produits périmés?",
        ...
        redeem_now:"Rédiger maintenant",
        download_now:"Télécharger maintenant",
        check_my_coupons:"Vérifier mes coupons",
        ...
        only_applicable:"Applicable uniquement aux achats de {name}",
